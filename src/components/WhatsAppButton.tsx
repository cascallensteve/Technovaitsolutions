  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      ...
      >
        ...
        <div
          className={`absolute right-16 top-1/2 transform -translate-y-1/2 bg-gradient-to-r from-gray-800 to-gray-700 text-white text-sm px-4 py-2 rounded-xl whitespace-nowrap transition-all duration-300 shadow-lg ${
        ...
        >
          ...
          <div className="absolute left-full top-1/2 transform -translate-y-1/2">
            ...
            >
              <path 
                d="M1 8C1 8 5 1 12 8C19 15 19 8 19 8" 
                stroke="currentColor" 
                strokeWidth="2" 
                strokeLinecap="round" 
                fill="none"
